...
function pg_traj(date, t, pg_raw, pg_noise, solar_error_max, p_rate, T, Pred_length,
    ...
    sg_max = 2*maximum(p_rate*pg_raw.pg_rt, dims=2)/baseMVA;
    ...
    rt_raw[2,:] = p_rate/0.25*feeder_solar.feeder_pg[2,:]/baseMVA;
    rt_raw[4,:] = p_rate/0.25*feeder_solar.feeder_pg[1,:]/baseMVA;
    rt_raw[5,:] = p_rate/0.25*feeder_solar.feeder_pg[3,:]/baseMVA;

    da_raw = p_rate*pg_raw.pg_da/baseMVA;
    da_raw[2,:] = p_rate/0.25*feeder_solar.feeder_pg_da[2,:]/baseMVA;
    da_raw[4,:] = p_rate/0.25*feeder_solar.feeder_pg_da[1,:]/baseMVA;
    da_raw[5,:] = p_rate/0.25*feeder_solar.feeder_pg_da[3,:]/baseMVA;
