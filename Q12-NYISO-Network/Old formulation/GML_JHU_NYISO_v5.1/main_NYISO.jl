...
###############################################################################
Q_solar_flag = 1;
# Q_solar_flag = 0 represent no reactive from solar / = 1 otherwise

val_opt = GML_solver(date, current_time, B_inp, raw_data, solar_percent,
    battery_capacity_percent, Q_solar_flag)
