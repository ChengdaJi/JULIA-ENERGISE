...
% rt_cost_no = lambda_rt(initial_pos+1:end_pos+1)' * p0_3(initial_pos:end_pos) *100/12


peak_bat = vpa(max(p0_1(initial_pos:end_pos))*1000000, 7)
peak_bat_peak = vpa(max(p0_2(initial_pos:end_pos))*1000000, 7)
% peak_no = max(p0_3(initial_pos:end_pos))*1000000
...
% sol_cul_no = sum(pcul_3(initial_pos:end_pos))*15*100/12
